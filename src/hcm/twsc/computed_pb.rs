...
//! machinery of [`crate::hcm::urban_segments::platoon_dispersion`], Equations 30-9
...
use crate::hcm::urban_segments::platoon_dispersion::{combined_arrival_profile, MovementDischarge};
use crate::hcm::twsc::twsc::{Mv, PlatoonBlockage, Twsc};
...
/// (Equation 30-9 machinery in [`crate::hcm::urban_segments::platoon_dispersion`]).
